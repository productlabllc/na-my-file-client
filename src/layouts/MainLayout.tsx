...
import { createBrowserRouter, RouterProvider, Link, Outlet, useNavigate, redirect } from 'react-router-dom';
import { Account, AccountContext, getPlatformUser } from '../scenes/auth/Account';
    ...
    <>
      <Account>
        ...
        <main className="content">
          ...
          <Topbar></Topbar>
          {location.pathname === '/account' ? <Dashboard></Dashboard> : <Outlet />}
        </main>
      </Account>
    </>
  );
